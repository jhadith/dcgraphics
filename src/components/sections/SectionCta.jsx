...
export function SectionCta({
  ...
  return (
    <div className="mt-8 flex flex-col gap-4 rounded-lg border border-navy/10 bg-white/70 p-4 shadow-[0_12px_34px_rgba(17,19,24,0.08)] backdrop-blur-xl sm:flex-row sm:items-center sm:justify-between">
      <div>
