...
export const mediaLibrary = {
  ...
  apparel: [
    ...
    localMedia("printigAndAppareal-todos/PrintingAndApparelNew", "menu.jpeg", "Printed menu sample"),
    localMedia("printigAndAppareal-todos/PrintingAndApparelNew", "menu2.png", "Custom menu printing sample"),
